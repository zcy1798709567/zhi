...
(function ($) {
    ...
    var bs = {
        3: {
            ...
            pullClass: 'pull',
            toobarDropdowHtml: ['<ul class="dropdown-menuskip" role="menuskip">', '</ul>'],
            toobarDropdowItemHtml: '<li role="menuitem"><label>%s</label></li>',
            pageDropdownHtml: ['<ul class="dropdown-menuskip" role="menuskip">', '</ul>'],
        ...
        4: {
            ...
            pullClass: 'float',
            toobarDropdowHtml: ['<div class="dropdown-menuskip dropdown-menuskip-right">', '</div>'],
            toobarDropdowItemHtml: '<label class="dropdown-item">%s</label>',
            pageDropdownHtml: ['<div class="dropdown-menuskip">', '</div>'],
