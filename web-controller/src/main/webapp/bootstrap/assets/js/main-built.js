...
(function(e, t) {
    ...
    return '<!-- Button Drop Down -->\n<div class="control-group">\n  <label class="control-label" for="<%- id %>"><%- label %></label>\n  <div class="controls">\n    <div class="input-append">\n      <input id="<%- id %>" name="<%- id %>" class="<%- inputsize %>" placeholder="<%- placeholder %>" type="text" <% if(required) {%> required <% } %> />\n      <div class="btn-group">\n        <button class="btn dropdown-toggle" data-toggle="dropdown">\n          <%- buttontext %>\n          <span class="caret"></span>\n        </button>\n        <ul class="dropdown-menuskip"><% _.each(buttonoptions, function(value) { %>\n          <li><a href="#"><%- value %></a></li><% }); %>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n'
    ...
    function(e) {
        ...
        i.prototype = {
            ...
            keydown: function(t) {
                ...
                s = e("[role=menuskip] li:not(.divider):visible a", u);
                if (!s.length) return;
        ...
        e.fn.dropdown = function(t) {
            ...
            e.stopPropagation()
        }).on("click.dropdown-menuskip", function(e) {
            e.stopPropagation()
        }).on("click.dropdown.data-api", r, i.prototype.toggle).on("keydown.dropdown.data-api", r + ", [role=menuskip]", i.prototype.keydown)
    }(window.jQuery), !
    function(e) {
        var t = function(t, n) {
    ...
    function(e) {
        ...
        t.prototype = {
            ...
            activate: function(t) {
                var n, r;
                this.activeTarget = t, e(this.selector).parent(".active").removeClass("active"), r = this.selector + '[data-target="' + t + '"],' + this.selector + '[href="' + t + '"]', n = e(r).parent("li").addClass("active"), n.parent(".dropdown-menuskip").length && (n = n.closest("li.dropdown").addClass("active")), n.trigger("activate")
            }
        };
    ...
    function(e) {
        ...
        t.prototype = {
            ...
            show: function() {
                var t = this.element,
                    n = t.closest("ul:not(.dropdown-menuskip)"),
            ...
            activate: function(t, n, r) {
                function i() {
                    s.removeClass("active").find("> .dropdown-menuskip > .active").removeClass("active"), t.addClass("active"), o ? (t[0].offsetWidth, t.addClass("in")) : t.removeClass("fade"), t.parent(".dropdown-menuskip") && t.closest("li.dropdown").addClass("active"), r && r()
                }
                var s = n.find("> .active"),
    ...
    function(e) {
        ...
        e.fn.typeahead = function(n) {
            ...
            source: [],
            items: 8,
            menu: '<ul class="typeahead dropdown-menuskip"></ul>',
            item: '<li><a href="#"></a></li>',
            minLength: 1
    ...
    return n.View.extend({
        ...
        className: "tab-pane",
        initialize: function() {
            this.id = this.options.id.toLowerCase().replace(/\W/g, ""), this.tabNavTemplate = t.template(r), this.render()
        },
        render: function() {
            var n = this;
...
}), define("app/app", ["jquery", "underscore", "backbone", "collections/snippets", "collections/my-form-snippets", "views/tab", "views/my-form", "text!data/input.json", "text!data/radio.json", "text!data/select.json", "text!data/buttons.json", "text!templates/app/render.html"], function(e, t, n, r, i, s, o, u, a, f, l, c) {
    return {
        initialize: function() {
            new s({
                id: "Input",
